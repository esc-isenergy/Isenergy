namespace IsEnergyModel.XSD.DP_PDOTPR_1_983_00_01_01_01
{//------------------------------------------------------------------------------
    // <auto-generated>
    ...
    public partial class ФайлДокумент
    {
        ...
        private ОтпрПол свОтпрДокField;

        private ОтпрПол свПолДокField;
        ...
        /// <remarks/>
        public ОтпрПол СвОтпрДок
        {
            get
            {
                return this.свОтпрДокField;
            }
            set
            {
                this.свОтпрДокField = value;
            }
        }

        /// <remarks/>
        public ОтпрПол СвПолДок
        {
            get
            {
                return this.свПолДокField;
            }
            set
            {
                this.свПолДокField = value;
            }
        }
    ...
    public partial class ОтпрПол
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlElementAttribute("ОтпрИП", typeof(ОтпрПолОтпрИП))]
        [System.Xml.Serialization.XmlElementAttribute("ОтпрЮЛ", typeof(ОтпрПолОтпрЮЛ))]
        public object Item
        {
            get
            {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class ОтпрПолОтпрИП
    {
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class ОтпрПолОтпрЮЛ
    {
    ...
    public enum ФайлДокументКНД
    {
        ...
        /// <remarks/>
        [System.Xml.Serialization.XmlEnumAttribute("1115111")]
        Item1115111,
    }
